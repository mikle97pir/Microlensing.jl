module Microlensing
    ...
    export generate_stars_rect, generate_stars_ell, build_tree, calc_mag,  par_calc_mag, distr_calc_mag, normalize_mag, calc_crit_curves, par_calc_crit_curves, calc_caustics
